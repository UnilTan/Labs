...
namespace MilkProductsImages.Models
{
    public class ImageContext : DbContext
    {
        ...
        {
            // Используем ту же БД, что и в основном проекте, но с другой таблицей
            optionsBuilder.UseSqlServer(@"Server=(localdb)\MSSQLLocalDB;Database=Familia22i1L9;Trusted_Connection=true;");
        }
